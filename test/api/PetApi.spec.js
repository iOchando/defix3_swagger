...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    factory(root.expect, root.SwaggerDasdsOpenApi30);
  }
}(this, function(expect, SwaggerDasdsOpenApi30) {
  'use strict';

  var instance;

  beforeEach(function() {
    instance = new SwaggerDasdsOpenApi30.PetApi();
  });
        ...
        it('should call findPetsByStatus successfully', function(done) {
          ...
          instance.findPetsByStatus(opts, function(error, data, response) {
            ...
            for (let p in dataCtr) {
              let data = dataCtr[p];
              expect(data).to.be.a(SwaggerDasdsOpenApi30.Pet);
            }
      ...
      describe('uploadFile', function() {
        it('should call uploadFile successfully', function(done) {
          ...
          instance.uploadFile(petId, opts, function(error, data, response) {
            ...
            // TODO: update response assertions
            expect(data).to.be.a(SwaggerDasdsOpenApi30.ApiResponse);
