...
let apiInstance = new SwaggerDasdsOpenApi30.UserApi();
let opts = { 
  'body': new SwaggerDasdsOpenApi30.User(), // User | Created user object
  'id': 789, // Number | 
...
let apiInstance = new SwaggerDasdsOpenApi30.UserApi();
let opts = { 
  'body': [new SwaggerDasdsOpenApi30.User()] // [User] | 
};
...
let opts = { 
  'body': new SwaggerDasdsOpenApi30.User(), // User | Update an existent user in the store
  'id': 789, // Number | 
  'username': "username_example", // String | 
  'firstName': "firstName_example", // String | 
  'lastName': "lastName_example", // String | 
